		...
		<>
			<div className='left-pos-16 h-16 flex items-center shadow-lg w-10/12 bg-white fixed z-50 pr-8'>
				...
				<div className='relative'>
					<Image height={35} width={35} className='rounded-full' src={user && user.photoURL || "https://t4.ftcdn.net/jpg/00/65/77/27/360_F_65772719_A1UV5kLi5nCEWI0BNLLiFaBPEkUbv5Fv.jpg"} alt="" />
				</div>
			</div>
