...
const Topbar = () => {
	...
	return (
		<>
			<div className='zindex1000 left-pos-16 h-16 flex items-center shadow-lg w-10/12 bg-white fixed pr-8'>
			...
			<div className={searchFocus ? 'zindex300 h-screen w-screen bg-black bg-opacity-20 fixed top-0 backdrop-blur-lg duration-500' : 'h-screen w-screen bg-black bg-opacity-0 pointer-events-none fixed top-0 backdrop-blur-none duration-500'}></div>
			<div className={searchFocus ? 'zindex1000 left-pos-16 top-16 flex items-center w-10/12 fixed z-50 shadow-lg duration-500 opacity-100' : 'opacity-0 -top-full duration-500 left-pos-16 flex items-center w-10/12 fixed z-50 shadow-lg'}>
